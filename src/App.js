...
const points = new Layers.PointTiles('lidar', 'http://localhost/~chelm/hdiz/austin/mesh_src_3857/{z}/{x}/{y}.csv.gz')
...
export default class App extends Component {
  render() {
    return (<ThreeMap center={[-97.739677,30.257936]} cam_zoom={1} layers={[images, pc1, pc2, pc3]}/>);
  }
}
